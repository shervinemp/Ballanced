...
if (EXISTS "${DEVKITPPC}/bin/powerpc-eabi-gcc")
    ...
    set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${MACH_DEP} -DGEKKO -DHW_RVL" CACHE STRING "" FORCE)
    set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${MACH_DEP} -DGEKKO -DHW_RVL" CACHE STRING "" FORCE)
    set(CMAKE_ASM_FLAGS "${CMAKE_ASM_FLAGS} ${MACH_DEP} -DGEKKO -DHW_RVL" CACHE STRING "" FORCE)
endif()
