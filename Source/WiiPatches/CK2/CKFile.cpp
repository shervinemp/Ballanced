...
CKERROR CKFile::ReadFileHeaders(CKBufferParser **ParserPtr) {
...
#ifdef WII
    header.Part0.CKVersion = __builtin_bswap32(header.Part0.CKVersion);
    header.Part0.FileVersion = __builtin_bswap32(header.Part0.FileVersion);
    header.Part0.FileVersion2 = __builtin_bswap32(header.Part0.FileVersion2);
    header.Part0.FileWriteMode = __builtin_bswap32(header.Part0.FileWriteMode);
    header.Part0.Hdr1PackSize = __builtin_bswap32(header.Part0.Hdr1PackSize);
#endif
...
#ifdef WII
        header.Part1.DataPackSize = __builtin_bswap32(header.Part1.DataPackSize);
        header.Part1.DataUnPackSize = __builtin_bswap32(header.Part1.DataUnPackSize);
        header.Part1.ManagerCount = __builtin_bswap32(header.Part1.ManagerCount);
        header.Part1.ObjectCount = __builtin_bswap32(header.Part1.ObjectCount);
        header.Part1.MaxIDSaved = __builtin_bswap32(header.Part1.MaxIDSaved);
        header.Part1.ProductVersion = __builtin_bswap32(header.Part1.ProductVersion);
        header.Part1.ProductBuild = __builtin_bswap32(header.Part1.ProductBuild);
        header.Part1.Hdr1UnPackSize = __builtin_bswap32(header.Part1.Hdr1UnPackSize);
#endif
    } else {
        return CKERR_INVALIDFILE;
    }
...
#ifdef WII
    m_FileInfo.Crc = __builtin_bswap32(header.Part0.Crc);
#else
    ...
    if (header.Part0.FileVersion >= 8) {
        header.Part0.Crc = 0;
#ifdef WII
        // Swap back to little endian byte-layout for computing the CRC
        header.Part0.CKVersion = __builtin_bswap32(header.Part0.CKVersion);
        header.Part0.FileVersion = __builtin_bswap32(header.Part0.FileVersion);
        header.Part0.FileVersion2 = __builtin_bswap32(header.Part0.FileVersion2);
        header.Part0.FileWriteMode = __builtin_bswap32(header.Part0.FileWriteMode);
        ...
        parser->Seek(prev);
#ifdef WII
        // Swap back to big endian for logic handling
        header.Part0.CKVersion = __builtin_bswap32(header.Part0.CKVersion);
        header.Part0.FileVersion = __builtin_bswap32(header.Part0.FileVersion);
        header.Part0.FileVersion2 = __builtin_bswap32(header.Part0.FileVersion2);
        header.Part0.FileWriteMode = __builtin_bswap32(header.Part0.FileWriteMode);
